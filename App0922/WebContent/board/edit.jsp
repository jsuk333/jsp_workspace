...
<%
	...
	BoardDTO dto=boardDAO.selectRecord(Integer.parseInt(request.getParameter("board_id")));
%>
...
<script>
	function edit(){
		if(confirm("수정하시겠습니까??")){
			form1.action="/board/editRecord.jsp";
			form1.submit();
		}
	}
</script>
	...
	<form name="form1" method="post">
		<table id="box" align="center" width="603" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<img src="/board/images/write_btin.gif" width="61" height="20" onClick="edit()"> <img src="/board/images/list_btn.gif" width="61" height="20">	</td>
		  </tr>
		  <tr>
		    <td height="1" bgcolor="#CCCCCC"></td>
		  </tr>
