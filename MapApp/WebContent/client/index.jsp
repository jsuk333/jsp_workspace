...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDeLONbnE2_Ewm9vTgaXjdhuSbuMir0nvY&signed_in=true&callback=initMap"></script>
</body>
</html>